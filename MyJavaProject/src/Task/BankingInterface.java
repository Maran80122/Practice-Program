...
//The bank should have a list of accounts and methods for adding them. Accounts should be an interface with methods to
//deposit, withdraw, calculate interest, and view balances.
